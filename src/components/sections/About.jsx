                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2">
                                <li>
                                    <strong> B.S. in Computer Science and Physics</strong> - Univeristy of Alberta (2022-2025)
                                </li>
                                <li>
                                    Relavent Coursework: Data Structures, Web Development. Cloud Computing
                                    Computing ...
                                </li>
                            </ul>
                        </div>
                        <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <div className="space-y-4 text-gray-300">
                                ...
                                <div>
                                    <h4 className="font-semibold"> Intern at ABC corp (2019-2020)</h4>
                                    <p> built stuff</p>
                                </div>
